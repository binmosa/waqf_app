...
class AuditLogsDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('id')->title('رقم السجل'),
            Column::make('log_name')->title(__('الموقع')),
            Column::make('description')->title(__('وصف العملية')),
            Column::make('subject_type')->title(__('نوع المستخدم')),
            Column::make('subject_id')->title(__('الحساب ')),
            Column::make('causer_id')->title(__('صاحب العملية')),
            Column::make('created_at')->title(__('وقت العملية')),
