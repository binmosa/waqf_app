...
class SupporterController extends Controller {
  ...
  public function index()
  {
    ...
    // $supporters = Supporter::with(['info' => fn($query) => $query->with(['user']), 'supporter_influence', 'membershipType','Supporter_contribution'])->latest()->paginate(10);
      $supporters = Supporter::with(['info', 'supporter_influence', 'membershipType','Supporter_contribution'])->latest()->paginate(10);
  ...
  {
    $data = $request->all();
    $userInfo = UserInfo::where('user_id',$data['user_info_id'])->first();
