...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $latestProjects = Project::latest()->take(self::PAGINATE_COUNT)->get(['name', 'start_date','end_date','description']);
        $latestBeneficiaries = Beneficiary::with(['User' => fn($query) => $query->with('user')])->latest()->paginate(self::PAGINATE_COUNT);
        //$Supporters = Supporter::with('User','Supporter_influence','MembershipType','Supporter_contribution')->get();
        $Supporters = Supporter::with(['info', 'supporter_influence', 'membershipType','Supporter_contribution'])->get();
        ...
        return view('pages.admin.dashboard', compact(
            ...
            'activities', 'latestProjects', 'financialSupport', 'latestBeneficiaries','Supporters'
        ));
    }
