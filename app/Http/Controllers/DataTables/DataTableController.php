...
class DataTableController extends Controller
{
    ...
    {
        $content = Activity::with('management')->get();
        ...
        return DataTables::of($content)
            ...
            ->editColumn('management_id', function ($row) {
                return $row->management ? $row->management->user->user->name : '';
            })
            ->addColumn('actions', function ($row) {
    ...
    public function payments_list()
    {
        ...
        return DataTables::of($content)
            ...
            ->addColumn('supporter', function ($row) {
                return $row->supporter->info->user->first_name  . " " . $row->supporter->info->user->last_name;
            })
