...
<div class="card {{ $class }}">
    ...
    <div class="card-body p-0 d-flex justify-content-between flex-column overflow-hidden" >
        ...
        <div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-9 pb-3">
            <div class="me-2">
                <span class="fw-bolder text-gray-800 d-block fs-3">الإيرادات</span>
        ...
        <!--begin::Chart-->
        <div class="mixed-widget-10-chart" data-kt-color="{{ $chartColor }}" data-kt-chart-url="{{ route('profits') }}"
