...
array('title' => 'سجل المساهمات', 'view' => 'supporter/payments'),
array('title' => 'العضوية', 'view' => 'supporter/membershiptypes'),
array('title' => 'التواصل مع الإدارة', 'view' => ('supporter/suggestions')),
array('title' => 'حقوق الداعم', 'view' => ('supporter/rightsDuties')),
);

$nav_volunteer = array(
array('title' => 'السجل التطوعي', 'view' => ('volunteer/volunteerLogs')),
);
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img src=@if(auth()->user()->info->avatar)"{{ asset('storage/avatars/'.auth()->user()->info->avatar)}}"  @else {{asset('/alkhirat/media/avatars/blank.png')}} @endif alt="image" />
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            @endif
                            @hasrole('beneficiary | volunteer | supporter')
                            <a href="#" class="btn  btn-light-success fw-bolder ms-2 fs-6 py-1 px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">
                                {!! theme()->getSvgIcon("icons/duotune/communication/com015.svg", "svg-icon-4 me-1") !!}
...
{{--                        <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover" title="قريباً">إرسال رسالة</a>--}}
                        ...
                        <button href="#" class="btn btn-sm btn-success me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_add_volunteer" title="انضم معنا">الانضمام كمتطوع</button>
                        @endif

                        @hasrole('volunteer')
                        <button  class="btn btn-sm btn-info me-3" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="عضو متطوع">عضو متطوع</button>
                        @endhasrole
                    </div>
                    <!--end::Actions-->
                </div>
                        ...
                        <div class="d-flex flex-wrap">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    @endif
                                    <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ $skillCount }}">0</div>
                                </div>
                                <!--end::Number-->

                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('مهاراتي') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    @else
                                        {!! theme()->getSvgIcon("icons/duotune/arrows/arr066.svg", 'svg-icon-3 svg-icon-success me-2') !!}
                                    @endif
                                    <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{ $certificateCount }}">0</div>
                                </div>
                                <!--end::Number-->

                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('شهاداتي') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    @else
                                        {!! theme()->getSvgIcon("icons/duotune/arrows/arr066.svg", 'svg-icon-3 svg-icon-success me-2') !!}
                                    @endif
                                        <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{$experienceCount}}">0</div>
                                </div>
                                <!--end::Number-->

                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('خبراتي') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                <!--begin::Number-->
                                <div class="d-flex align-items-center">
                                    @if($necessityCount == null || $necessityCount == 0)
                                        {!! theme()->getSvgIcon("icons/duotune/arrows/arr065.svg", 'svg-icon-3 svg-icon-danger me-2') !!}
                                    @else
                                        {!! theme()->getSvgIcon("icons/duotune/arrows/arr066.svg", 'svg-icon-3 svg-icon-success me-2') !!}
                                    @endif
                                       <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{$necessityCount}}">0</div>
                                </div>
                                <!--end::Number-->

                                <!--begin::Label-->
                                <div class="fw-bold fs-6 text-gray-400">{{ __('خدماتي') }}</div>
                                <!--end::Label-->
                            </div>
                            <!--end::Stat-->
...
{{--                                <!--begin::Label-->--}}
{{--                                <div class="fw-bold fs-6 text-gray-400">{{ __('مساهماتي التطوعية') }}</div>--}}
{{--                                <!--end::Label-->--}}
{{--                            </div>--}}
{{--                            <!--end::Stat-->--}}
        ...
        <!--begin::Navs-->
        <div class="d-flex overflow-auto h-auto">
            <!-- to wrap use: flex-nowrap -->
