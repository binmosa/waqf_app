...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" aria-expanded="true">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">{{ __('خبراتي') }}</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
            ...
            <div class="card-header border-0 pt-6">
               ...
               <div class="card-toolbar">
                  ...
                  <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                     <!--begin::Add customer-->
                     <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">إضافة خبرة</button>
                     <!--end::Add customer-->
                  </div>
                  <!--end::Toolbar-->
                  <!--begin::Group actions-->
               ...
               <table class="table align-middle table-row-dashed table-responsive-lg fs-6 gy-5" id="kt_customers_table">
                  ...
                  <thead>
                     ...
                     <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">إلى تاريخ</th>
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr>
                        ...
                        <td>
                            ...
                            @else
                                <a target="_blank"
                                   href="{{ url(asset('storage/attachments/experience/' . $value->attachment)) }}">
                                    <img alt="Icon" style="height:40px; width: 40px;"  src="{{asset('/alkhirat/media/svg/files/pdf.svg')}}"></a>
                            @endif


                        <td class="">
                            <a href="{{ route('settings.deleteexperience', $value->id) }}"  class="btn btn-danger btn-sm delete-skill"
                     ...
                     <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                           ...
                           <div class="fv-row mb-7">
                              ...
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input required type="text" class="form-control form-control-solid"  name="job_title" placeholder="المسمى الوظيفي" />
                              <!--end::Input-->
                           </div>
                           <!--end::Input group-->
                           <!--begin::Input group-->
                           <div class="fv-row mb-7">
                              ...
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input required type="text" class="form-control form-control-solid"  name="company" placeholder="الشركة" />
                              <!--end::Input-->
                           </div>
                           <!--end::Input group-->
                           <!--begin::Input group-->
                           <div class="fv-row mb-7">
                              ...
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input required type="date" class="form-control form-control-solid"  name="start_date" placeholder="تاريخ البدء" />
                              <!--end::Input-->
                           </div>
                           <!--end::Input group-->
                           <!--begin::Input group-->
                           <div class="fv-row mb-7">
                              ...
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input required type="date" class="form-control form-control-solid"  name="end_date" placeholder="تاريخ الانتهاء" />
                              <!--end::Input-->
                           </div>
                           <!--end::Input group-->
                           <!--begin::Input group-->
                           <div class="fv-row mb-7">
                              ...
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input required type="text" class="form-control form-control-solid" name="note" placeholder="note" />
                              <!--end::Input-->
                           </div>
                           <!--end::Input group-->
                           <!--begin::Input group-->
                           <div class="row mb-6">
                              <!--begin::Label-->
                              <label class="required col-lg-4 col-form-label fw-bold fs-6">{{ __('مرفق') }}</label>
                              <!--end::Label-->
                              <!--begin::Col-->
                              <div class="col-lg-8">
                                 <!--begin::Image input-->
                                 <div >
                                    <!--begin::Inputs-->
                                    <input required type="file" name="attachment" accept=".png, .jpg, .jpeg, .pdf"/>
                                 </div>
                                 <!--end::Image input-->
                                 <!--begin::Hint-->
