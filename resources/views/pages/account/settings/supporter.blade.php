            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="row">
                            <!--begin::Col-->
                            <div class="col-lg-12 fv-row"><span>رقم العضوية</span>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="row">
                            <!--begin::Col-->
                            <div class="col-lg-12 fv-row"><span>نوع العضوية</span>
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-2 fv-row"><span>التخصص</span>
                    ...
                    <div class="col-lg-2 fv-row"><span>نوع الإحالة</span>
                    ...
                    <div class="col-lg-2 fv-row"><span>الإحالة</span>
                        <input type="text" disabled class="form-control form-control-lg form-control-solid"
                        placeholder="الاحالة" value="{{ $info->supporter->referral->value  }}"/>
                    </div>
                    <div class="col-lg-2 fv-row"><span>من قبل</span>
                        <input type="text" disabled class="form-control form-control-lg form-control-solid"
                        placeholder="المعرف" value="{{ $info->supporter->referral->referrer_user_id  }}"/>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{ __('الحساب البنكي / الوظيفة') }}</label>
                    <!--end::Label-->

                    <!--begin::Col-->
                    <div class="col-lg-5 fv-row"><span>رقم الحساب البنكي</span>
                    ...
                    <div class="col-lg-3 fv-row"><span>الوظيفة/المهنة</span>
                        <input type="text" name="work" class="form-control form-control-lg form-control-solid"
                        placeholder="الوظيفة / المهنة" value="{{ old('work', $info->supporter->work ?? '') }}"/>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
