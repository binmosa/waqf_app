    ...
    <div id="kt_account_profile_details" class="collapse show">
        ...
        <!--begin::Card body-->
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{ __('جهة العمل') }}</label>
                    <!--end::Label-->
                ...
                <div class="row mb-6">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label fw-bold fs-6">{{ __('الحي ') }}</label>
                    <!--end::Label-->
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <label class="form-check form-check-inline form-check-solid me-5">
                               ...
                               $debug = var_export($info, true);
                                 ?>
                                <input type="hidden" name="contact_method[email]" value="0">
                                <input class="form-check-input" name="contact_method[email]" type="checkbox" value="1"
                            ...
                            <label class="form-check form-check-inline form-check-solid">
                                <input type="hidden" name="contact_method[phone]" value="0">
                                <input class="form-check-input" name="contact_method[phone]" type="checkbox" value="1"
