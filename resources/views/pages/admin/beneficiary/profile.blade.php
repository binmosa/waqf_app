                    ...
                    <div class="col-lg-8 fv-row">
                        ...
                        <div class="d-flex align-items-center mt-3">
                            ...
                            <label class="form-check form-check-inline form-check-solid me-5">
                                ...
                                <input class="form-check-input" name="contact_method[email]" type="checkbox" value="1" {{ old('marketing', $info->contact_method['email'] ?? '') ? 'checked' : '' }}/>
                            ...
                            <label class="form-check form-check-inline form-check-solid">
                                ...
                                <input class="form-check-input" name="contact_method[phone]" type="checkbox" value="1" {{ old('email', $info->contact_method['phone'] ?? '') ? 'checked' : '' }}/>
                                <span class="fw-bold ps-2 fs-6">
                                    {{ __('الهاتف') }}
                                </span>
                            </label>
