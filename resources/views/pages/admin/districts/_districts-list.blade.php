<div class="block mb-5">
    ...
    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">
        ...
        <!--end::Svg Icon-->إضافة منطقة جديدة</button>
    <!--end::Add user-->
</div>
               ...
               <table class="table align-middle table-row-dashed fs-6 gy-5 table-responsive-lg" id="kt_customers_table">
                  ...
                  <tbody class="fw-bold text-gray-600">
                     ...
                     <tr>
                        ...
                        <!--begin::Name=-->
                        <td>
                           <a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $value->distric }}</a>
                        </td>
                        <td>{{ $value->city }}</td>
                        <td class="">
                        @hasrole('superadmin')
                        <form method="post" class="form"
                                            action="{{  route('districts.destroy', $value->id) }}">
                                            @csrf
                                            @method('DELETE')
               ...
               <div class="modal-content">
                  ...
                  <form class="form" method="POST"  enctype="multipart/form-data"
                     ...
                     <div class="modal-header" id="kt_modal_add_customer_header">
                        <!--begin::Modal title-->
                        <h2 class="fw-bolder">منطقة جديدة</h2>
                        <!--end::Modal title-->
                        <!--begin::Close-->
                     ...
                     <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                           ...
                           <div class="fv-row mb-7">
                              <!--begin::Label-->
                              <label class="required fs-6 fw-bold mb-2">المنطقة</label>
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input type="text" class="form-control form-control-solid"  name="distric" placeholder="المنطقة" />
                              <!--end::Input-->
                           </div>
                           <!--end::Input group-->
                           <!--begin::Input group-->
                           <div class="fv-row mb-7">
                              <!--begin::Label-->
                              <label class="required fs-6 fw-bold mb-2">المدينة</label>
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input type="text" class="form-control form-control-solid"  name="city" placeholder="المدينة" />
                              <!--end::Input-->
                           </div>
                           <!--end::Input group-->
                           <!--end::Input group-->
