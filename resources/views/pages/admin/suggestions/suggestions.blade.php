    ...
    <div class="d-flex flex-column flex-lg-row">
        ...
        <div class="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 mb-lg-0">
            ...
            <div class="card card-flush mb-0" data-kt-sticky="false" data-kt-sticky-name="inbox-aside-sticky" data-kt-sticky-offset="{default: false, xl: '0px'}" data-kt-sticky-width="{lg: '275px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
                ...
                <div class="card-body">
                    <!--begin::Button-->
                    <a href="#" class="btn btn-primary text-uppercase w-100 mb-10">صندوق المقترحات</a>
                    <!--end::Button-->
                    <!--begin::Menu-->
        ...
        <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
            <div class="card">
                @if(count($info->suggestionsReceiver)==0)
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                    ...
                    <div class="d-flex flex-stack flex-grow-1">
                        <div class="fw-bold">
                            <h4 class="text-gray-900 fw-bolder">صندوق المقترحات فارغ</h4>
                            <div class="fs-6 text-gray-700">لا توجد اي مقترحات في صندوق الوارد
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="kt_inbox_listing_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="table-responsive">
                            <table class="table table-hover table-row-dashed fs-6 gy-5 my-0 dataTable no-footer" id="kt_inbox_listing">
                                ...
                                <thead class="">
                                    <tr>
                                        <th class="sorting" tabindex="0" aria-controls="kt_inbox_listing" rowspan="1" colspan="1" aria-label="Actions: activate to sort column ascending" style="width: 0px;">المرسل</th>
                                        <th class="sorting" tabindex="0" aria-controls="kt_inbox_listing" rowspan="1" colspan="1" aria-label="Title: activate to sort column ascending" style="width: 0px;">العنوان</th>
                                        <th class="sorting" tabindex="0" aria-controls="kt_inbox_listing" rowspan="1" colspan="1" aria-label="Date: activate to sort column ascending" style="width: 0px;">التاريخ</th>
                                    </tr>
                                </thead>
                                <!--end::Table head-->
                                <!--begin::Table body-->
                                <tbody>
                                    @foreach($info->suggestionsReceiver->sortByDesc('created_at') as $key=>$value)
                                    <tr class="odd">
                                        <td class="ps-9">
                                            <a href="{{ url('admin/suggestionShow/'.$value->id)}}" class="d-flex align-items-center text-dark">
                                                <div class="symbol symbol-35px me-3">
                                                    <div class="symbol-label bg-light-danger">
                                                        <span class="text-danger"><?php echo substr($value->infoSender->user->first_name, 0, 2); ?></span>
                                                    </div>
                                                </div>
                                                <span class="fw-bold">{{ $value->infoSender->user->first_name.' '.$value->infoSender->user->last_name }} </span>
                                            </a>
                                        </td>
                                        <td>
