                ...
                <div class="d-flex flex-column flex-lg-row">
                    ...
                    <div class="flex-column flex-lg-row-auto w-100 w-lg-275px mb-10 mb-lg-0">
                        ...
                        <div class="card card-flush mb-0" data-kt-sticky="false" data-kt-sticky-name="inbox-aside-sticky" data-kt-sticky-offset="{default: false, xl: '0px'}" data-kt-sticky-width="{lg: '275px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95">
                            ...
                            <div class="card-body">
                                <!--begin::Button-->
                                <a href="#" class="btn btn-primary text-uppercase w-100 mb-10">صندوق الوارد</a>
                                <!--end::Button-->
                                <!--begin::Menu-->
                                <div class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary mb-10">
                                    ...
                                    <div class="menu-item mb-3">
                                        <!--begin::Inbox-->
                                        <a href="{{ url('supporter/suggestion') }}">
                            ...
                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <div class="fw-bold">
                                        ...
                                        <div class="fs-6 text-gray-700">لا توجد اي رسالة في صندوق الوارد
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-row-dashed fs-6 gy-5 my-0 dataTable no-footer" id="kt_inbox_listing">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd">
                                                    <td class="ps-9">
                                                        <a href="{{ url('supporter/suggestionShow/'.$value->id)}}" class="d-flex align-items-center text-dark">
                                                            <div class="symbol symbol-35px me-3">
                                                                <div class="symbol-label bg-light-danger">
                                                                    <span class="text-danger"><?php echo substr($value->infoSender->user->first_name, 0, 2); ?></span>
                                                                </div>
                                                            </div>
                                                            <span class="fw-bold">{{ $value->infoSender->user->first_name.' '.$value->infoSender->user->last_name }} (الادارة)</span>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <div class="text-dark mb-1">
                                                            <a href="{{ url('supporter/suggestionShow/'.$value->id)}}" class="text-dark">
