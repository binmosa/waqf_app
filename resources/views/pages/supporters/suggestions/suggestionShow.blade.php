                    ...
                    <div class="flex-lg-row-fluid ms-lg-7 ms-xl-12">
                        <div class="card">
                            <div class="card-header align-items-center py-5 gap-5">
                                <div class="d-flex">
                                    <a href="{{ url('supporter/suggestions') }}" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="الرجوع للوارد" data-bs-original-title="Archive">
                                ...
                                <div class="d-flex align-items-center">
                                    <a href="{{ url('supporter/suggestion') }}" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="إرسال رسالة جديدة" data-bs-original-title="Next message">
