...
<div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" aria-expanded="true">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('سجل المساهمات') }}</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th>م</th>
                                    <th class="min-w-125px">مقدار المساهمة</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach($info->supporter->payment as $key => $value)
                                <tr>
                                    <td>
                                    ...
                                    <td> {{ $value->id }} </td>
                                    <td>
                                        <span class="text-gray-800 fs-5 text-hover-primary mb-1">{{ $value->amount }}  </span>ريال سعودي
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @if(!$value->attachment)
                                            لايوجد
                                        @else
                                            <a target="_blank" href="{{ url(asset('storage/attachments/payments/' . $value->attachment)) }}">
                                                <img class="icon" src="{{asset('/alkhirat/media/icons/duotune/files/fil003.svg')}}"></a>
                                        @endif
                                    </td>
