...
use App\Http\Controllers\Beneficiary\{BeneficiaryController,
    BeneficiaryServiceController,
    CertificateController,
    ExperienceController,
    NecessityController,
    SkillController};
use App\Http\Controllers\DataTables\{BeneficiaryDataTablesController,
    DataTableController,
...
use App\Http\Controllers\management\{ContributionTypeController,
    DistrictController,
    InfluenceTypeController,
...
use App\Http\Controllers\Supporter\{PaymentController,
    Supporter_contributionController,
    Supporter_influenceController,
    SupporterController};
use App\Http\Controllers\Volunteer\{Volunteer_logController, VolunteerController};
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('suggestion', [SuggestionController::class, 'createSuggestion'])->name('admin.suggestion');
        Route::post('suggestion', [SuggestionController::class, 'storeSuggestion'])->name('admin.storeSuggestion');
        Route::get('suggestionShow/{id}', [SuggestionController::class, 'showSuggestion'])->name('admin.suggestionShow');
        Route::get('suggestions', [SuggestionController::class, 'listSuggestions'])->name('admin.suggestions');
        Route::get('suggestionsSent', [SuggestionController::class, 'sentSuggestions'])->name('admin.sentSuggestions');
        Route::get('settings/overview/{user}', [DashboardController::class, 'userOverview'])->name('admin.settings.overview');
        Route::get('login/back', [DashboardController::class, 'adminLogin'])->name('admin.login.back');

        Route::post('newBeneficiary',[RegisteredUserController::class,'adminStore'])->name('admin.registerBeneficiary');
    });
